...
//        pos.z += 0.5f;
        ...
        renderPhysicsShape(sr, pos, collisionShape);
    }
    ...
    public static void renderRigidBody(ShapeRenderer sr, PhysicsRigidBody rigidBody) {
        ...
        renderPhysicsShape(sr, pos, rigidBody.getCollisionShape());
    }

    public static void renderPhysicsShape(ShapeRenderer sr, Vector3f off, CollisionShape parent0) {
        if (parent0 instanceof CompoundCollisionShape parent) {
            ...
            com.jme3.bounding.BoundingBox box = parent0.boundingBox(off, new Quaternion(), new com.jme3.bounding.BoundingBox());
            renderBoundingBox(sr, box);
        }
    }
